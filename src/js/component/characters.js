...
export const Characters = (props) => {
  ...
  More Info...
      ...
      <div className="modal fade" id={"exampleModal" + props.id} tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <button className="addfavourite btn ms-4 mt-1 justify-content-center" onClick={() => {actions.setFavourites({type:"character", id: props.character.uid, name: props.character.name})}}>Add to Favourites</button>
