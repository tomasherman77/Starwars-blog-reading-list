  ...
  <div className="modal fade" id={"exampleStarshipModal" + props.sid} tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="card modal-dialog">
          ...
          <p><strong className="yellow">Class: </strong>{props.starships.starship_class}</p>
            ...
            <button className="addfavourite btn  ms-4 mt-1" onClick={() => {actions.setFavourites({type:"starships", id: props.starships.uid, name: props.starships.name})}}>Add to Favourites</button>
          </div>
